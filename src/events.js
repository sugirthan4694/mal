...
const EVENTS = [
  ...
  { id: 'E6', day: 5, type: 'DEBIT', account: 'ACC-001', amount: '620.00', valueDay: 2 },
  { id: 'E7', day: 5, type: 'AUTHORIZATION', account: 'ACC-001', authId: 'Auth-B', amount: '90.00', valueDay: 5 },
  { id: 'E8', day: 6, type: 'REVERSAL', account: 'ACC-001', reverses: 'E7', valueDay: 2 },
  { id: 'E9', day: 5, type: 'CREDIT', account: 'ACC-002', amount: '10.000', valueDay: 5, instalments: 3 },
];
